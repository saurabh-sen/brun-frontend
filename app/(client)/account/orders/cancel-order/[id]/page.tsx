...
const CancelOrder = ({ params }: { params: { id: string } }) => {
  ...
  return (
    <div className='cancelorder my-28 flex gap-6 flex-wrap max-w-6xl mx-auto justify-between uppercase'>
      {
        showConfirm ?
          <div className="cancelorder__left max-w-[542px]">
            <h1 className='text-3xl'>ORDER CANCELLELATION REQUEST SENT</h1>
          ...
          : <div className="cancelorder__left max-w-[542px]">
            <h1 className='text-3xl'>ARE YOU SURE YOU WANT TO CANCEL THE ORDER?</h1>
            <div className="button__container flex justify-between items-center mt-4">
