...
const Navbar = () => {
  ...
  return (
    <>
      <header className={`w-full flex items-center md:items-start justify-between pt-3 md:pt-7 px-6 bg-transparent bg-gradient-to-b from-[#000000cb] via-[#00000043] to-transparent fixed top-0 transition-all duration-500 z-10 `}>
