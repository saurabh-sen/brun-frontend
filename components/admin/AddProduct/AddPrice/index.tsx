  ...
  return (
    <div id='addprice'>
      ...
      <div className="input__price flex items-center gap-4">
        <AddPriceInput icon='₹' placeholder='ADD BASE PRICE (SELLING PRICE)' name='productSellPrice' type='text' />
        <AddPriceInput icon='%' placeholder='ADD DISCOUNT' name='productDiscount' type='text' />
      </div>
    </div>
  )
}
...
const AddPriceInput = ({ icon, placeholder, name, type }: IAddPriceInput) => {
  ...
  return (
    <div className="addpriceinput relative">
