...
const AddBasicDetails = () => {
  return (
    <div id="addbasicdetails">
      ...
      <MyBoxInput id="productname" label="PRODUCT NAME" name="productName" type="url" className="mb-10" />
      <MyBoxTextArea id="writedescription" label="WRTIE DESCRIPTION" name="productDescription" className="mb-6" />
    </div>
  )
}
