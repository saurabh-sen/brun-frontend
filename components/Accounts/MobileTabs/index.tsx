    ...
    return (
        <div className='account__tabs m-3'>
            <div className="account__tabs__header flex items-center gap-4">
                <MyOutlinedButton active={activeTab === 1} handleClick={() => setActiveTab(1)}>ACCOUNT</MyOutlinedButton>
                <MyOutlinedButton active={activeTab === 2} handleClick={() => setActiveTab(2)}>ORDERS</MyOutlinedButton>
            </div>
