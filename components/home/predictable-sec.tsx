...
const PredictableSec: NextPage<PredictableSecType> = ({ featured }) => {
  return (
    <section className=" w-full relative max-w-full flex flex-row items-start justify-start py-0  box-border relative  text-left text-11xl text-black font-urbanist">
