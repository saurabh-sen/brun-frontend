...
const PRODUCTCATEGORIES = [ ProductCategoryEnum.ALL_PRODUCTS, ProductCategoryEnum.BOTTOMS, ProductCategoryEnum.TOPS, ProductCategoryEnum.CREW_NECKS, ProductCategoryEnum.POLO, ProductCategoryEnum.FULL_SLEEVES_POLO, ProductCategoryEnum.SWEAT, ProductCategoryEnum.SHIRT ];

const PRODUCTSIZE = [ ProductSizeEnum.XXXS, ProductSizeEnum.XXS, ProductSizeEnum.XS, ProductSizeEnum.S, ProductSizeEnum.M, ProductSizeEnum.L, ProductSizeEnum.XL, ProductSizeEnum.XXL ];

export type { IProductListing, IProductListingState };

export {  ProductListingLayoutEnum, ProductCategoryEnum, ProductAvailabilityEnum, ProductSizeEnum, PRODUCTCATEGORIES, PRODUCTSIZE }